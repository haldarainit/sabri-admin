        ...
        <div style={styles.companyRight}>
          ...
          <div style={styles.customerDetails}>
            ...
            <p style={styles.customerAddress}>
              ...
              <br />
              {orderData.shippingAddress?.city || "N/A"}, {orderData.shippingAddress?.state || "N/A"} - {orderData.shippingAddress?.zipCode || "N/A"}
            </p>
        ...
        <div style={styles.summaryLeft}>
          ...
          <div style={styles.paymentInfo}>
            <p style={styles.paymentDetail}>
              <strong>Payment Method:</strong> {orderData.paymentMethod === "cash_on_delivery" ? "Cash on Delivery" : orderData.paymentMethod || "N/A"}
            </p>
            <p style={styles.paymentDetail}>
        ...
        <div style={styles.summaryRight}>
          ...
          <div style={styles.summaryTable}>
            ...
            {calculateSavings() > 0 && (
              <div style={styles.summaryRow}>
                <span>You Save:</span>
                <span style={styles.savingsText}>{formatCurrency(calculateSavings())}</span>
              </div>
            )}
            {orderData.orderSummary?.couponDiscount > 0 && (
              <div style={styles.summaryRow}>
                <span>Coupon Discount ({orderData.orderSummary?.couponCode}):</span>
                <span style={styles.discountText}>-{formatCurrency(orderData.orderSummary.couponDiscount)}</span>
              </div>
            )}
            <div style={styles.summaryRow}>
              <span>Shipping:</span>
              <span>
                {orderData.orderSummary?.shippingCharge === 0 ? "FREE" : formatCurrency(orderData.orderSummary?.shippingCharge)}
              </span>
            </div>
            <div style={styles.summaryRow}>
            ...
            <div style={styles.summaryTotal}>
              ...
              <span><strong>{formatCurrency(orderData.orderSummary?.total)}</strong></span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div style={styles.footer}>
        <div style={styles.footerLeft}>
          ...
          <p style={styles.footerText}>
            Thank you for choosing Sabri Jewellery. We appreciate your business and look forward to serving you again.
          </p>
        </div>
